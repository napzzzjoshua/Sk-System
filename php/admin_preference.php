...
// --- DATA LOGIC: NOTIFICATIONS & CHAT (Consistent with dashboard) ---
...
// Note: In a real system, these would be fetched from a 'system_settings' table
$settings = [
...
<head>
    ...
    <title>SK Admin - Preferences</title>
    ...
    <style>
        ...
        input:checked + .slider { background-color: var(--navy-primary); }
...
<body class="flex">
    ...
    <main class="main-content flex-grow">
        <header class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-[#1B1B4B]">System Preferences</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="card-white">
                <h3 class="text-sm font-bold mb-6 flex items-center gap-2">
                    <i class="fa-solid fa-gear text-blue-500"></i> General Settings
                </h3>
                ...
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[10px] text-gray-400">Disable user access to the portal temporarily.</p>
                        </div>
                        <label class="toggle-switch">
                            <input type="checkbox" <?= $settings['maintenance_mode'] ? 'checked' : '' ?>>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-bold text-slate-700">Public Registration</p>
                            <p class="text-[10px] text-gray-400">Allow new youths to register via the signup page.</p>
                        </div>
                        <label class="toggle-switch">
                            <input type="checkbox" <?= $settings['allow_registration'] ? 'checked' : '' ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-bold text-slate-700">Submission Archiving</p>
                            <p class="text-[10px] text-gray-400">Automatically archive approved requests after 30 days.</p>
                        </div>
                        <label class="toggle-switch">
                            <input type="checkbox" <?= $settings['auto_archive'] ? 'checked' : '' ?>>
                            <span class="slider"></span>
                        </label>
                    </div>
                </div>
            ...
            <div class="card-white">
                <h3 class="text-sm font-bold mb-6 flex items-center gap-2">
                    <i class="fa-solid fa-bell text-[#FFD700]"></i> Notification Rules
                </h3>
                
                <div class="space-y-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-bold text-slate-700">Admin Email Alerts</p>
                            <p class="text-[10px] text-gray-400">Receive email for every new financial aid request.</p>
                        </div>
                        <label class="toggle-switch">
                            <input type="checkbox" <?= $settings['email_alerts'] ? 'checked' : '' ?>>
                            <span class="slider"></span>
                        </label>
                    </div>

                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase mb-3">Backup & Recovery</p>
                        <button class="w-full py-2 bg-slate-50 border border-slate-200 rounded-lg text-xs font-semibold hover:bg-slate-100 transition flex items-center justify-center gap-2">
                            <i class="fa-solid fa-download"></i> Download Database Backup
                        </button>
                    </div>

                    <div class="pt-2">
                        <button class="w-full py-2 bg-red-50 text-red-600 rounded-lg text-xs font-semibold hover:bg-red-100 transition flex items-center justify-center gap-2">
                            <i class="fa-solid fa-trash-can"></i> Clear System Cache
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-6 flex justify-end gap-3">
            <button class="px-6 py-2 rounded-xl text-xs font-bold text-gray-500 hover:bg-gray-100 transition">Cancel</button>
            <button onclick="alert('Preferences Saved!')" class="px-6 py-2 rounded-xl text-xs font-bold bg-[#1B1B4B] text-white shadow-lg shadow-indigo-900/20 hover:opacity-90 transition">Save Preferences</button>
        </div>
    </main>
